...
ObSQLSessionInfo::ObSQLSessionInfo()
  ...
  cached_arena_for_transformer_(NULL),
...
void ObSQLSessionInfo::destroy()
{
  ...
  if (NULL != cached_arena_for_transformer_)
  {
    cached_arena_for_transformer_->~ObArenaAllocator();
    arena_pointers_.free(cached_arena_for_transformer_);
    TBSYS_LOG(DEBUG, "destroy allocator, addr=%p", cached_arena_for_transformer_);
...
{
  ObArenaAllocator* ret = cached_arena_for_transformer_;
  if (NULL == ret)
  {
...
void ObSQLSessionInfo::free_transformer_mem_pool_for_ps(ObArenaAllocator* arena)
{
  if (OB_LIKELY(NULL != arena))
  {
    ...
    {
      cached_arena_for_transformer_ = arena;
