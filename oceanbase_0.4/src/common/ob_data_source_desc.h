...
namespace oceanbase
{
  namespace common
  {
    ...
    struct ObDataSourceDesc
    {
      ...
      {
        OCEANBASE_INTERNAL, // from same cluster
        OCEANBASE_OUT, // from other cluster, uri=oceanbase://rs_ip:rs_port
        DATA_SOURCE_PROXY, // from data source proxy, uri=proxy://data_source_name://path/to/sstable/dir
