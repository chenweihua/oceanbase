  ...
  namespace liboblog
  {
    ...
    class ObLogServerSelector : public IObLogServerSelector
    {
      ...
      private:
        ...
        int query_cluster_info_(MYSQL *mysql, IdRoleMap &cluster_id2role);
        int query_ups_info_(MYSQL *mysql, IdRoleMap &cluster_id2role);
        int query_rs_info_(MYSQL *mysql, IdRoleMap &cluster_id2role);
      private:
        bool inited_;
