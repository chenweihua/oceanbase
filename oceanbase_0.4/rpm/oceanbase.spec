...
BuildRequires: t-csrd-tbnet-devel >= 1.0.9 lzo >= 2.06 snappy >= 1.1.2 libaio-devel >= 0.3 t_libeasy-devel = 1.0.21-274.el6 openssl-devel >= 0.9.8 mysql-devel >= 5.1.0
...
Version: %VERSION
BuildRequires:curl >= 7.15.5 mysql-devel >= 5.1.0 t-db-congo-drcmessage >= 0.1.1-22 tb-lua-dev >= 5.1.4
Requires: curl >= 7.15.5 mysql-devel >= 5.1.0 t-db-congo-drcmessage >= 0.1.1-22 openssl-devel >= 0.9.8
Release: %{RELEASE}
...
%{_prefix}/lib/libobsql.la
%{_prefix}/lib/libobsql.so
%{_prefix}/lib/libobsql.so.0
